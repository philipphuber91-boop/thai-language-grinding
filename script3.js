...
speichern.addEventListener("click", function () {
    ...
    localStorage.setItem("quest3_zeit", zeit.value);
    localStorage.setItem("quest3_wpm", wpm.value);
    localStorage.setItem("quest3_genauigkeit", genauigkeit.value);

});

zeit.value = localStorage.getItem("quest3_zeit");
wpm.value = localStorage.getItem("quest3_wpm");
genauigkeit.value = localStorage.getItem("quest3_genauigkeit");