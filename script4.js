...
speichern.addEventListener("click", function () {
    ...
    localStorage.setItem("quest4_zeit", zeit.value);
    localStorage.setItem("quest4_wpm", wpm.value);
    localStorage.setItem("quest4_genauigkeit", genauigkeit.value);

});

zeit.value = localStorage.getItem("quest4_zeit");
wpm.value = localStorage.getItem("quest4_wpm");
genauigkeit.value = localStorage.getItem("quest4_genauigkeit");